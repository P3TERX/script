...
# File name: lazydocker.sh
# Description: Install latest version lazydocker
...
PROJECT_NAME='lazydocker'
GH_API_URL='https://api.github.com/repos/jesseduffield/lazydocker/releases/latest'
