...
# Description: Install latest version Docker Compose
...
GH_API_URL='https://api.github.com/repos/linuxserver/docker-docker-compose/releases/latest'
...
case ${OS_ARCH} in
x86_64 | amd64)
    FILE_KEYWORD='compose-amd64'
    ;;
aarch64 | arm64)
    FILE_KEYWORD='compose-arm64'
    ;;
arm*)
    FILE_KEYWORD='compose-armhf'
    ;;
*)
